...
\begin{prop}[Proyección\IS a un convexo cerrado]  Sea $(H, \pesc{·,·})$ un espacio de Hilbert y sea $E ⊂ X$ un convexo cerrado y no vacío. Entonces existe un único $x ∈ E$ que minimiza la función $\norm{x}$.
