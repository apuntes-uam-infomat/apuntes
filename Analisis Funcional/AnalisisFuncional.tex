...
\begin{defn}[Operador\IS compacto] Sea $H$ un espacio de Hilbert y $\appl{k}{H}{H}$ lineal. Se dice que es compacto si, dada una sucesión $x_n \wconvs x$ entonces $k(x_n) \to k(x)$ con convergencia fuerte.
