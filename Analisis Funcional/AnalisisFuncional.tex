...
\begin{theorem}[Teorema\IS de Banach-Alaoglu] Sea $X = Y^*$ un espacio de Banach dual. Entonces \[ \bola_X = \adh{\bola}_1(0) = \{ x \in X \tq \norm{x}_X \leq 1 \} \] es compacto en la topología débil-$*$ de X.
\end{theorem}
