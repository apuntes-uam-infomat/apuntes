...
Probar, sin emabrgo, que la afirmación anterior es falsa si $\dual$ es un espacio dual en el cual damos la topología débil-$*$. \hint{¿Qué ocurre con $\bola_X$ si $X$ no es reflexivo?}
