...
\begin{theorem}[Teorema\IS de representación de Riesz] \label{thm:Riesz} Sea $H$ un espacio de Hilbert sobre un cuerpo base \kbb y $H^*$ su dual. Entonces, existe un anti-isomorfismo \begin{align*}
\appl{Φ}{H&}{H^*} \\
