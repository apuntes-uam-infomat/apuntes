...
\spart $\exists x (\phi \to \psi) \models (\exists x  \phi )\to  (\exists x \psi)$.

\spart  $(\exists x  \phi )\to  (\exists x \psi) \models  \exists x (\phi \to \psi) $.

\spart $\exists x (\phi \to \psi) \models (\forall x  \phi ) \to  (\exists x \psi)$.

\spart  $(\forall x  \phi ) \to  (\exists x \psi) \models  \exists x (\phi  \to \psi) $.


\spart  $ \phi  \models  \forall x \phi$.

\spart $\forall x (\phi \to \psi) \models (\forall x  \phi )\to  (\forall x \psi)$.

\spart  $(\forall x  \phi )\to  (\forall x \psi) \models  \forall x (\phi \to \psi) $.

\spart $\exists x (\phi \to \psi) \models (\forall x  \phi ) \to  (\exists x \psi)$.

\spart  $(\exists x  \phi ) \to  (\forall x \psi) \models  \forall x (\phi  \to \psi) $.

\spart $\forall x (\phi \to \psi) \models (\exists x  \phi )\to  (\exists x \psi)$.
