...
\solution
\spart
Por el segundo Teorema de incompletitud de Gödel, no hay un algoritmo que dada $\psi_n$ pueda decidir si es cierta o no.

Luego no podemos saber si los naturales son un modelo de esta teoría o no.
