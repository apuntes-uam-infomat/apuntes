...
\textbf{Solución del profesor}:
	$\mathbb{N}$ es un conjunto. $n\rightarrow z_n$ es una función, luego su rango $S=\{z_1, z_2, \hdots\}$ es un conjunto. $\forall z_i\in S$, $S\cap z_i\ni z_{i+1}$ contradice fundación y no asumimos que dos $z_i$ son distintos. Por tanto se excluye $z_1\ni z_2\ni \hdots \ni z_n\ni z_1$.
\end{problem}
