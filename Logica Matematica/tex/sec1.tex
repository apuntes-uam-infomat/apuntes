...
\begin{example}
	...
	$\{\neg, \iff\}$ no se tiene claro si es completo. Está propuesto como ejercicio.\ref{ejer::H3P10} 
\end{example}
...
\begin{theorem}[Teorema de la completitud]	Sea $T = \emptyset$.
	\begin{itemize}
		\item \textbf{Validez}: 
		$\vdash p \implies \vDash p$
