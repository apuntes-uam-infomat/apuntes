...
\begin{proof}
	...
	Pero si ocurre esto, de $M \cup \{p\}$ se deduce $p$ (puesto que forma parte directamente de la teoría) pero también se deduce $\neg p$ por lo que $M\cup\{p\}$ no sería consistente. De forma similar ocurre con $M \cup \{\neg p \}$, con lo que llegamos a una contradicción.
