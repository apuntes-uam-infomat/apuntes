...
\begin{proof}
	\begin{itemize}
		...
		Sea $p_1,\hdots, p_n=q$ una demostración de $q$. La demostración es por inducción en la longitud de las pruebas (fórmulas).
	...
	\begin{itemize}
		...
		\item Si $q$ no es axioma ni está en $T$, entonces $q = p$, $T\cup\{p\}\vdash p$
