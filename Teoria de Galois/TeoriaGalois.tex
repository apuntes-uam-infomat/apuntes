...
\paragraph{Pequeño recuerdo:}$φ$ es una función que cuenta el número de coprimos con $n$, es decir, $φ(6) = φ(2·3) = φ(2)·φ(3) = 1·2=2$. En este caso, los coprimos con 6 son $1,5$. Para el caso especial de $n = p$, tenemos que $φ(p) = p-1$. Además, $φ(p)=p-1 \dimplies ℤ/pℤ$ es un cuerpo.
...
Se plantea como ejercicio, para afianzar la aplicación del teorema, calcular $∀n=7,...,20 [ℚ(e^{\frac{2πi}{n}}):ℚ]$ y sus polinomios irreducibles.
\appendix
\chapter{Ejercicios}
