...
\begin{theorem}[Resoluilidad por radicales]
...
Observamos también que $\gal(F_{m-1}/F_{m-2})$ es abeliano. Entonces,por la proposición anterior y los teoremas de isomorfía (vistos en Estructuras Algebraicas), probamos que $\gal(E/F)$ es soluble por la observación siguiente. 
...
Aparte de esta propiedad, hay otras que uno puede esperar como que el subgrupo abeliano de un soluble es soluble (y cosas del estilo)
...
$K/\{1\} = K$ abeliano (solo hay 2 opciones $K\approx C_2×C_2$ o $K\approx C_4$, ambos abelianos). Podemos construir $K$ (no se muy bien cómo) y obtenemos: $K = \{id,(1,2)(3,4),(1,3),(2,4),(1,4)(2,3)\}$ en el que todos los elementos son de orden 2 por lo que $K \approx C_2×C_2$
