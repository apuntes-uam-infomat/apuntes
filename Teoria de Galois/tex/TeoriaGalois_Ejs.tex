...
$$\begin{array}{ccccc}\mathcal{F}_3(x_3,y_3) &\subset& \mathcal{F}_3(x^3,y^3)(x) &\subset& \mathcal{F}_3(x,y^2)(y)\\
&\downarrow& & \downarrow&\\
&p_1(t) = t^3-x^3& & p_2(t) = t^3-y^3&\end{array}$$

¿Es irreducible? $\dimplies$ ¿Tiene raices en $\mathcal{F}_3(x^3,y^3)$?

$t^3-x^3 = (t-x)^3$ en $\mathcal{F}_3(x,y)$. Este polinomio solo tiene una raíz, que es $x$.

Entonces:

¿Es irreducible? $\dimplies$ ¿Tiene raices en $\mathcal{F}_3(x^3,y^3)$? $\dimplies$ ¿$x∈\mathcal{F}_3(x^3,y^3)$?

Podemos encontrar respues más fácilmente a la ultima pregunta de la siguiente manera:

$$x = \frac{\sum a_{ij}(x^3)^i(y^3)^i}{\sum b_{ij}(x^3)^i(y^3)^i}; a_{ij},b_{ij} ∈ \mathcal{F}_3$$
$$\dimplies \sum b_{ij} x^{3i+1}y^{3i+1} = \sum a_{ij} x^{3i}y^{3i}$$

Aquí aplica algo del pequeño teorema de Fermat.
...
\spart Si $γ∈\mathcal{F}_3(x,y) \implies γ^3 ∈\mathcal{F}_3(x^3,y^3)$.

Supongamos que esto es verdad. Entonces: 

$$[\mathcal{F}_3(x^3,y^3)(γ) : \mathcal{F}_3(x^3,y^3)(γ)] ≤ 3$$ porque $γ$ satisface el polinomio $t^3 -γ^3 ∈ \mathcal{F}_3(x^3,y^3)[t]$


$$γ = \frac{\sum a_{ij}(x^3)^i(y^3)^i}{\sum b_{ij}(x^3)^i(y^3)^i}; a_{ij},b_{ij} ∈ \mathcal{F}_3$$

¿Cuanto vale $γ^3$? Como tiene $Ch(\mathcal{F}) = 3$ recordamos que $(a+b)^{3} = a^3 + b^3$.

Por lo que: $$γ^3 = \frac{\sum a_{ij}^3(x^3)^i(y^3)^i}{\sum b_{ij}^3(x^3)^i(y^3)^i}; a_{ij},b_{ij} ∈ \mathcal{F}_3 \implies γ^3 ∈ \mathcal{F}_3 \implies [... : ...] ≤ 3$$
...
Aplicando el pequeño teorema de Fermat (que dice que en $Ch(\mathcal{F}_p) \implies a^p = a, ∀a∈\mathcal{F}_p$)
