...
\begin{itemize}
\item El grupo de Galois va a ser un subgrupo de $S_5$ (opción 1: por número de elementos: tengo 5 raíces que llevar a 5 sitios distintos $\implies 5!$  Y ya sabemos que $|S_5| = 5!$)\footnote{Creo}
