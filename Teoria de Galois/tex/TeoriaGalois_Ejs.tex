...
El teorema del que disponemos (en su versión general) dice que todo polinomio de grado ≥ 5 que tenga solamente 2 raíces complejas es irresoluble por radicales. En clase lo hemos visto para n=5, pero al parecer es general (pondría la fuente pero han sido varias y no me acuerdo).
...
\begin{itemize}
\item $S_5 = \{<(1,2),(1,2,3,4,5)>\}$. Si el grupo de Galois del polinomio tiene 2 generadores, uno de orden 2 y el otro de orden 5 entonces será isomorfo a $S_5$.
...
Ya hemos encontrado 2 elementos identificables a generadores de otro grupo, con lo que el grupo de Galois será isomorfo $S_5$. 

La pega que le podemos encontrar a este razonamiento es porqué basta con encontrar elementos identificables. ¿Y si estos no son generadores del grupo de Galois? Estoy en ello...
