...
\begin{problem}[3]
\ppart Calcular el grado de la extensión $\mathcal{F}_3(x, y)/\mathcal{F}_3(x_3, y_3)$.

\ppart Encontrar todas la extensiones de la inclusión $\mathcal{F}_3 (x_3 , y_3) → \mathcal{F}_3(x, y)$.
