...
\textcolor{red}{Parra: Esas uniones e intersecciones son finitas o infinitas?}

\textcolor{blue}{Pedro: No se habla de intersecciones aún. Dado que después definimos la $\salgb$ como un álgebra cerrada para uniones numerables, y en las propiedades que ves a continuación se habla de conjuntos $A_1$, ... $A_n$, podemos deducir que aquí se trata de uniones finitas}
\end{enumerate}
\end{defn}
...
\textcolor{red}{Parra: Con intersección numerable a que nos referimos? infinita pero numerable? y la unión puede ser infinita pero no numerable o que?}

\textcolor{blue}{Pedro: Intersección numerable significa intersección de una colección numerable de conjuntos. Por supuesto que puede ser infinito pero no numerable. La unión: $\bigcup_{x\in \real}(x-ε,x+ε)$ es infinita pero no numerable, por que el conjunto $\real$ es no numerable.}
...
\textcolor{red}{Parra: Por qué? si X es infinito numerable no estaríamos en la misma situación que en ejemplo anterior? En el que concluimos que no podía ser $\sigma$-algebra}

\textcolor{blue}{Pedro: La situación anterior a la que haces referencia debió ser fruto de tu imaginación. Decimos que una $\salgb$ es cerrada para uniones numerables. Aquí además, añadimos la condición de que sean disjuntas. En la demostración vemos que si una unión disjunta numerable se contiene en $\algbM$ entonces cualquier unión numerable también lo hará.}
...
Entonces $µ^*_{|\algbM}$ es una medida cuya restricción a $\algbA$ coincide con $µ_0$.
...
Entonces, puesto que $E \subset A$ tenemos que
