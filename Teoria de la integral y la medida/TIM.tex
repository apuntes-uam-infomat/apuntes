...
\textcolor{red}{Parra:Qué es cerrado por complementación finita? que la union finita de elementos del complementario es cerrado?}
...
\textcolor{blue}{Lo de finita sobra, simplemente tenemos que saber que $\algbM$ es cerrado por complementación.}
\end{enumerate}
\end{defn}
...
\textcolor{blue}{Oh Dios mio!! El increíble capitán obvio acaba de pasar por aquí!!}
...
\textcolor{blue}{Es lo mismo la mínima $\salgb$ que contiene a un conjunto que la $\salgb$ generada por dicho conjunto. La $\salgb$ generada por un conjunto se define como la mínima $\salgb$ que lo contiene.}
\end{itemize}
...
\item \textbf{Medida de Lebesgue} en la $\salgb$ de los medibles de un intervalo (a,b).
...
es una $\salgb$ y exsite una única medida $\overline{µ}$ extensión de µ a $\overline{\algbM}$, que se denomina \textbf{compleción de µ}
\end{theorem}
\begin{proof}
...
Donde $\algb{L}$ es la $\salgb$ de Lebesgue.
\end{defn}
