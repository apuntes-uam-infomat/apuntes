...
%
% Propiedad 12
\item La medida exterior es numerablemente aditiva sobre los compactos, es decir:
...
\begin{prop}
\[C \subset I \ es \ medible \Leftrightarrow \forall \epsilon > 0 \exists K \ compacto \ \wedge O \ abierto \ con \ K \subset C \subset O \subset I \tq m(O \smallsetminus K) < \epsilon\]
\end{prop}
...
Veamos como demostramos que la unión de medibles es medible:
\[Sean \ C_1, C_2 \subset I \ medibles \ \Rightarrow \forall \epsilon > 0 \exists K_1, K_2 \ compactos \ O_1, O_2 \ abiertos \tq\]
