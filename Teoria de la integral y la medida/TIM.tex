...
\item $\algb{M}$ es cerrado por la unión \textcolor{blue}{unión finita}
...
\textcolor{blue}{$\bigcup_{n=1}^{\infty} A_n$. Unión de un conjunto numerable de elementos. Ya que los naturales son numerables y va de n=1 hasta $\inf$.}
