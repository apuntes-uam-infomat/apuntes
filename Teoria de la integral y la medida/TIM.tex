...
\begin{prop}
El conjutno de las funciones integrables forma un espacio vectorial y la integral es un funcional lineal en ese espacio.
\end{prop}
\begin{proof}
Debemos ver que:
...
\[\text{ Dada }\forall n f_n\in L^1(µ), \ f_n \rightarrow f \ a.e.(µ) \]
