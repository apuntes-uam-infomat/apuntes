...
\textcolor{red}{Parra: Todo medible tiene un subconjunto no vacío de medida finita...$\forall E \subset M, Existe un A \in M, con A\neq 0, y A \subset E, tal que 0<µ(A)<\infty$}
...
\textcolor{red}{Parra: Un subconjunto F contenido en F con F..., a lot of F's my friedn, ya lo corrijo yo. LUEGO LO REVISO}

\textcolor{green}{Parra, lo definitivo a mi gusto sería:
Todo medible tiene un subconjunto no vacío de medida finita. Dado un espacio de medida ($X, \algb{M}, µ$), se dice que µ es semifinita si todo $E\subset \algb{M}$ tiene un subconjunto $F\subset E$ con $F\in \algb{M}$ y $F \neq \emptyset$ tal que 0<µ($E$) < $\infty$}
