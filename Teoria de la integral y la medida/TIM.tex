...
\begin{theorem}
Sea $(X, \algbM, µ)$ un espacio de medida y sea $\algbM = \{N \in \algbM: µ(N)=0\}$
...
$\overline{\algbM}$ está cerrada por uniones numerables, es decir
%TODO completar, es simple

También se cumple que $\overline{\algbM}$ es cerrada por complementación.
%TODO completar.

Definimos la extensión $\overline{µ}$ como:
...
Bien, pues ahora vamos a realizar algo parecido.
...
Sea $X \neq \emptyset$ y sea $µ^*$ una medida exterior en $X$. Entonces
