...
\textcolor{red}{¿Por qué van a existir obligatoriamente unos $I_k$ tal que su unión menor que a? En la definición te dice que $S \subset O$, no te dice que sean del mismo tamaño, no le veo el sentido. Además según como hemos definido O, se supone que los intervalos deben recubrir O entero..., no se, no me cuadra mucho...}
...
\[\prod_{α\in A}E_α = \bigcap_{α\in A} \pi^{-1}(ε_α)\]
\end{itemize}
\end{proof}

\begin{prop}
Con la notación anterior, si $\algb{M}_α$ es la $\salgb$ generada por un conjunto $ε_α$, es decir: $\algb{M}_α = \algb{M}(ε_α)$ entonces:
...
$\algb{F}_1 \subset ε_1 \Rightarrow \algb{M}(\algb{F}_1) \subset \otimes_{α\in A}\algb{M}_α$
\item $\supset$
Observemos que:
