...
\begin{prop} $C \subset I$ \ es \ medible si y sólo si $\forall \epsilon > 0$ e existe un $K$ compacto y un $O$ abierto, con $K⊆C⊆O⊆I$ tales que $m(O\setminus K) < \epsilon$.
\end{prop}
...
\[\prod_{\alpha\in A}E_\alpha = \bigcap_{\alpha\in A} \pi^{-1}(\epsilon_\alpha)\]
\end{itemize}
\end{proof}
