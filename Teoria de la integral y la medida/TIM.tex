...
\obs Otros conjuntos que están en $\algb{B}_X$ son: los cerrados, la intersección numerable de abiertos: $\algb{G}_\delta$, la unión numerable de cerrados: $\algb{F}_\sigma$, unión numerable de $\algb{G}_\delta$ y la intersección numerable de $\algb{F}_\sigma$.
