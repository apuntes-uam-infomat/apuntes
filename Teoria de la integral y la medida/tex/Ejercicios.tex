...
\textcolor{red}{Parra: no hace falta demostrar que el vacío y el total pertenecen a $\algbA$. esas dos propiedades se cumplen si y solo si se cumplen las de cerrado por complementacion y por union finita}
\end{problem}
...
\textcolor{red}{Na tio, desde que sacaste un 1 me fío mazo de tus demostraciones. Que cojones un 100\%!! No me fio una puta mierda vamos...}
...
\textcolor{red}{Parra: Las intersecciones también serían $(0, \frac{1}{n}]$ o $(\frac{1}{n}, 1]$, no?}
