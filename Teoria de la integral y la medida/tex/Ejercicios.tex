...
\[\lim(\inf E_k)=\bigcup_{j=0}^{\infty}\bigcap_{k=j}^{\infty}E_k\]
\[\lim(\sup E_k)=\bigcap_{j=0}^{\infty}\bigcup_{k=j}^{\infty}E_k\]
%TODO analizar brevemente por qué esto es lógico.
...
La convergencia representada con la flecha se deriva de:
%TODO A ver que coño pongo aquí
...
siendo $E=\bigcup_{j=0}^{\infty}E_j$ y al hablando del complementario hacemos como el complementario dentro de $E$
...
\[\liminf A_n = \emptyset\]
puesto que este límite consiste en tomar la unión de todos los elementos que están presenten en todos los elementos de la sucesión. No hay ningún elemento que esté en todos los elementos y por ello obtenemos el vacío.
Así mismo
\[\limsup A_n = X\]
