...
\[\int_0^1\frac{x}{1-x}\log\frac{1}{x}dx = \int_0^1\sum_{n=0}^{\infty}x^{n+1}(10-\log(x))\]

\textcolor{red}{Ni idea}
\end{problem}
...
\textcolor{red}{No termina de salirme pero apostaría a que, de alguna forma, podemos ver que esta integral es infinita, lo que implicaría que las integrales iteradas difieren o son infinitas y en cualquier caso, eso conlleva que la función no es integrable.}
\end{problem}