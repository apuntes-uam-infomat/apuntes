...
\[= k(\frac{1}{2}-\frac{1}{3})\]
De donde obtenemos fácilmente que $k = \frac{1}{\frac{1}{2}-\frac{1}{3}}$

La función de distribución sería:
\[F(x)= \int_{-\infty}^{x} \ind_{[0,1]} = \left\{ \begin{array}{lcc}
             0 &   si  & x < 0 \\
             \\ \int_{0}^{x}kt(1-t)dt & si &  0 \leq x \leq 1 \\
             \\ 1 &  si  & 1 \leq x
             \end{array}
   \right.
\end{problem}
...
\begin{enumerate}
\item Hataa α para que $f$ sea una función de densidad de probabilidad
