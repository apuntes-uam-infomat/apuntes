...
\paragraph{Particular} Como no podemos ver a ojo que la solución sea un polinomio de grado 3 (como en el ejercicio 9), utilizamos el \textbf{método de variación de las constantes} \index{Método!variación de constantes}.
...
\easyimgw{./Imagenes/Hoja4Ej5.png}{$f_n$}{4.5}{0.7}
...
\solution
\spart Falso.
\easyimg{Imagenes/Hoja4Ej11Aa.png}{Contraejemplo}{H4E11Aa}
