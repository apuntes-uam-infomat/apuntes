...
\begin{defn}[Representación geométrica]
...
\begin{defn}[Representación abstracta]
...
\begin{example}
En el caso $G = S_n$\footnote[1]{Aquel grupo de las permutaciones de elementos}
...
\paragraph{Caso 2: $p \nmid   \mathrm{card}\, (Z(G))$} \pbreak
  Para la demostración de este caso, será útil recordar la ecuación de clases de conjugados (\ref{defEqConj}). Si tengo G finito, tomo $\appl{Inn}{G}{Aut(G)}$  que define una partición del conjunto G en subconjuntos de la forma $cl(a)=\{gag^{-1} \tq g\in G\}$.
...
\begin{theorem}[Teorema\IS de Sylow (II)]
 $H, H'$ son p-subgrupos de Sylow, entonces $gHg^{-1}=H'$
\end{theorem}
...
\begin{example}[Clave de las claves para este examen]
 ...
 Por el tercer teorema de Sylow, si $n_2=\#\{2-subgrupos \ de \ Sylow \} \Leftarrow \ n_2|3 \ \wedge n_2\equiv 1 mod(2)$, y de la misma forma si $n_3=\#\{3-subgrupos \ de \ Sylow \} \Leftarrow \ n_3|4 \ \wedge n_3\equiv 1 mod(3)$.
 ...
 \begin{lemma}
  ...
  Si $|H_3xH_{11}|=|G| \Rightarrow G\simeq H_3\times H_{11}$
 \end{lemma}
 \begin{proof}
