...
\begin{example}
 ...
 Los $I$ buscados serán de la forma $p\mathbb{Z}$  con $p$ primo, ya que cada subgrupo de $\mathbb{Z}$ que contenga a I estará asociado con un ideal de $\mathbb{Z}/I$. Si queremos que sea un cuerpo, sólo debe tener un ideal propio (aparte de él mismo) por lo que el retículo de ideales sólo podrá tener dos elementos.
...
A partir de esta definición tendríamos que  $\card{A/I}$ sería el número de ideales que ``se interponen''  entre I y A. Además,  $A/I$ es un cuerpo si y sólo si I es maximal.

\begin{example}
 Vamos a analizar $\mathbb{Q}[X]$. Con cualquier polinomio puedo formar un ideal
