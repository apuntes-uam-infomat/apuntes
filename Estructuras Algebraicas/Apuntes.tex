...
\subsection{Subgrupos}
 ...
 \end{defn}
  ...
  \begin{lemma}
   ...
   $$H\ subgrupo\ normal\ \implies la\ partición\ izquierda\ coincide\ con\ la\ derecha\ (a_iH = Ha_i)$$
   $$H\ subgrupo\ normal\ \implies \pi \ =\ \pi '$$
  ...
  \begin{defn}
	Llamamos centro del grupo $G$ al grupo formado por los elementos que conmutan con todos los elementos de 		$G$.:\\
