...
\end{defn}
 ...
 \end{theorem}
\begin{example}
 Tenemos $\bar{K}\in \mathdbb{Z}/n\mathbb{Z}$  con subgrupos <$\bar{d_1}$>, <$\bar{d_2}$>,..., <$\bar{d_r}$> con r divisor de n.\\
...
\begin{proof}
 La explico mientras se desvanecía como una nube de polvo y por ende no me quedó clara. La analizaré y subiré correctamente.
\end{proof}
