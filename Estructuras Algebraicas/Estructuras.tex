...
\begin{lemma}
 f(x) $\in \ \mathbb{K}[X]$  es irreducible $\Leftrightarrow$  <f> es maximal.
\end{lemma}
\begin{proof}
...
\end{lemma}
\begin{proof}
 Para simplicar, haremos la demostración para polinomios de grado 3. El lector podrá inferir a partir de ahí fácilmente las demostraciones
 para polinomios de grados 1 y 2.\\
