...
\begin{example}[Clave de las claves para este examen]
 ...
 \begin{example}
  ...
  \begin{enumerate}
   ...
   \item Dados $H_1$,  $H_2$, subgrupos de G $\Rightarrow$ $\appl{\varphi}{H_1xH_2}{G}$, siendo $\varphi(h_1,h_2)=h_1h_2$
   \item Para cada p solo existe un p-subgrupo de Sylow
   \item $\forall r \tq r / |G| \ G_r\{g \in G \tq g^{r}=e\}$  es un subgrupo
   \item Dados $n_1, n_2 \tq n=n_1n_2=|G| \ \Rightarrow G \equiv G_{n_1}xG_{n_2}$
   \begin{proof}
