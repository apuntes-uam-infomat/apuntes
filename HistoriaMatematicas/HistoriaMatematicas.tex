...
Supongamos que el conjunto $\{n \ t.q.\text{ no es primo ni puede escribirse como producto de primos}\}$ no es vacío

Tomo un elemento de este conjunto y lo escribo como producto de dos números menores que él: $n=pq$. Si $p$ o $q$ están en mi conjunto, repito el procedimiento.

Finalmente, llegaré a obtener números primos, que ya no estarán en el conjunto, obteniendo así una factorización en números primos.
...
Puesto que ambos son primos, entonces $p_1 \nmid q_1 \implies p_1 | q_2\cdot .... \cdot q_n$ y podemos repetir este procedimiento teniendo ahora una cadena más corta.
\end{enumerate}
...
\[mp_1+nq_1 = 1 \implies mp_1r +nq_1r = r\]
