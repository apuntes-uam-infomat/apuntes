...
La idea se apoya en que dado un punto de la circunferencia unidad, la ecuación que lo describe, $x^2+y^2=1$ se asemeja a otra que podemos obtener a partir del Teorema de Pitágoras:
...
La idea es muy sencilla. Si tomo rectas que salgan del $(-1,0)$ con pendientes racionales, al intersecar estas rectas con la circunferencia, obtendremos coordenadas raciones.
...
También es muy sencillo de comprobar que el recíproco es cierto, basándonos en la definición de la pendiente. Si tenemos dos puntos racionales en el plano, la pendiente será un número racional puesto que no hacemos más que restar y dividir las coordenadas racionales.
...
\begin{center}
\includegraphics[width=0.8\linewidth/2]{img/pitagoras2.png}
\end{center}

Podemos comprobar sencillamente que el area del cuadrado mayor es igual a la suma de las áreas de los triángulos y del cuadrado menor.
...
Podemos observar fácilmente que los dos triángulos azules son iguales pues tienen dos lados un ángulo iguales.

Por otro lado podemos ver que cada triángulo azul es equivalente al triángulo verde con el que comparte cuadrado puesto que comparten base y altura.

Por tanto, los 4 triángulos que hemos dibujado tienen el mismo área.

Combinando estas dos relaciones podemos ver que el área del cuadrado de lado $c$, que es el doble que la del triángulo verde es igual a la del rectángulo de vértices $B,D1,D3$.

Siguiendo un razonamiento anágolo pero jugando con el cuadrado de lado $b$ tenemos que el área de la otra parte del rectángulo de vértices $D3,D2,C$.

Como conlcusión llegamos a que el área del cuadrado de lado $a$ es igual a la suma de las áreas de los otros dos cuadrados, es decir
\[a^2+b^2=c^2\]
...
\item Dos lados/ángulos iguales en un triángulo implican dos ángulos/lados iguales repectivamente.
...
\section{Euclides}
Euclides vivió en torno al año 300 a.C. en Alejandría, aunque su existencia es dudosa, pues no hay pruebas de la existencia de ninguna persona cuya vida coincida con la conocida de Euclides.
...
Euler nos proporcionó un algoritmo para calcular el máximo común divisor de dos números que aún hoy en día sigue empleándose.
...
Pero este ejemplo no termina de ser del todo claro, pues estamos trabajando con aproximaciones y con la calculadora, cosa que no termina de encajar con la realidad de la antigua Grecia. Sin embargo, el siguiente ejemplo nos muestra cómo se pudo demostrar la irracionalidad de $\sqrt{3}$ en el mundo griego.
...
\section{Arquímedes}
\textbf{Arquímedes de Siracusa}, nacido en torno al año 287 a.C. fue un físico, ingeniero, inventor, astrónomo y matemático griego. Aunque se conocen pocos detalles de su vida, es considerado uno de los científicos más importantes de la Antigüedad clásica.

Entre sus avances en física se encuentran sus fundamentos en hidrostática, estática (mecánica) y la explicación del principio de la palanca. Es reconocido por haber diseñado innovadoras máquinas, incluyendo armas de asedioy el tornillo de Arquímedes, que lleva su nombre.
...
\subsubsection{Aproximación por polígonos}\label{subsec::arquimedes}
...
\subsubsection{Aproximación trigonométrica (Taylor)}\label{sec::taylor}
...
x_1=3, y_1 =1, N_1 = x_1^2-7y_1^2 = 2 \\
x_2=5, y_2 =2, N_2 = x_2^2-7y_2^2 = -3 \\
x_3=8, y_3 =3, N_3 = x_2^2-7y_2^2 = 1
\end{array}\]
...
\appendix
\chapter{Ejercicios}
\input{tex/HistoriaMatematicas_Ejs.tex}
