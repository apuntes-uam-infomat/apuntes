...
\begin{prop}
S es convexo si y sólo si $S = conv(S)$
\end{prop}

\begin{proof}
$\impliedby}$: $S = conv(S) \implies S$ convexo es trivial, vamos a demostrar la otra implicación:

$\implies)$: Vamos a demostrarlo por inducción:
...
$(1)$ es una combinación convexa, con lo que este paréntesis $\in S$. Por otro lado, ...
