...
\centering
\begin{tikzpicture}
\fill[shading = axis,rectangle, left color=blue!60!white, right color=left!30!white,shading angle=135,blue!60!white] (0,1) -- (2,0) -- (7,0) -- (7,7) -- (0,7);
\node[anchor=north east] at (0,4) {$(0,4)$};
\draw (-4,0) -- (0,4) -- (4,8);
\draw[->] (0,0) -- (0,8);
\draw[->] (0,0) -- (8,0);
\end{tikzpicture}
\caption{Solución gráfica del \fref{ej:ejercicio2.14.a}, apartado \roman{spart}}
\end{figure}
