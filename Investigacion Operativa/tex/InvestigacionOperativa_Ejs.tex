...
Variables $x_i = $ calidad de A ó B.

\begin{ioprob}
\goal{$\max 500x_1 + 250 x_2$}
\restriccions{$20x_1 + 10x_2 \leq 100$}{$180x_1 + 160x_2 \leq 660$}{$x_i \geq 0$}{}{}{}
\end{ioprob}
...
\draw[thick,-,color=red] (1,0) -- (0,2);
\draw[thick,-,color=red] (2,-2) -- (-1,4);
\draw node[anchor=south] {$(3.8,0)$};
\end{tikzpicture}
\label{ej:1.1.a}
