		...
		\section{Criptosistema afín (sobre letras)}
			...
			\begin{prop}
				...
				\begin{proof}
					...
					$f_{a,b}$ inyectiva $\implies$ $f_{a,b}^{-1} = f_{a^{-1},-a^{-1}b}$

					$f_{a,b}$ sobreyectiva (porque $\mathbb{Z}/N$ es finito) $\implies$

					$$\exists \alpha \in \mathbb{Z}/N : f_{a,b}(\alpha) = 1 + b \implies a \alpha + b = 1 + b \implies a \alpha = 1$$
