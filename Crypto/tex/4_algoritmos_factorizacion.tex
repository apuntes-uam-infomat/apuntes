...
Lo siguiente es mirar $mcd(x-y, n)=mcd(46\cdot 47 \cdot 49 \cdot 51 - 2^5\cdot 3^2 \cdot 5^2 \cdot 7, 2041)$, y en caso de que sea $2041$ o $1$ tendríamos $x=\pm y \mod n$ y no se satisfaría el criterio de Kraichik (no nos valen $x$ e $y$ para decir que $n=2041=x^2-y^2$).
\end{example}
