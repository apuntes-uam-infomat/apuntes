...
\[Base: aa, bb \in L\]
\[Hipótesis:\ \forall w \in R \tq \abs{w} \leq 2n \Rightarrow w \in L\]
\[Inducción: w'\in L \ \abs{w'} = 2n+2 \Rightarrow w' = axa | bxb \tq \abs{x} = 2n \Rightarrow x \in L \Rightarrow w' \in L\]
