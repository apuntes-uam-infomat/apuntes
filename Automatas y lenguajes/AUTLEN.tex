...
\end{center}
IMPORTANTE: Un autómata determinista tiene que tener todas las transiciones definidas, se sobreentiende que las transiciones que no están dibujadas van a un quinto estado en el cual se quedan colgadas.
...
%TODO autómata a pila del lenguaje ese.
...
\end{example}
%TODO Completar con la clase del lunes. Creo que con completar la explicacioncilla del ejemploy el anterior que introduce los automatas a pila será suficiente.
