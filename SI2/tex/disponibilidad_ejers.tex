...
disponibilidad de la capa de aplicación si se colocan en ella do servidores de aplicaciones.
\ppart En el caso de la base de datos, la recuperación tras un fall no se realiza a través de las reparaciones habituales, sino que s dispone de un cluster activo-pasivo. El tiempo de conmutación al servidor pasivo se compone de los siguientes tiempos:
\begin{itemize}
