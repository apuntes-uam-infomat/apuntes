...
\subsection{Más ejemplos}
	...
	\begin{example}{\bf 7}
		...
		Recordemos que el gradiente\index{Gradiente} debe ser perpendicular al conjunto de nivel:
		...
		(DIBUJO DOBLEZ PLANO TG VERTICAL) %help!
		\begin{figure}[hbtp]
