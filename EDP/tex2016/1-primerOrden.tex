...
\section{Caso general: Problema de Cauchy}
	...
	\begin{example}{\bf 2}
		...
		De este sistema obtenemos un \concept{Sistema\IS característico}, cuyas soluciones serán curvas características:
		...
		Sus soluciones será las {\bf curvas características}\index{Curva!característica}:
	...
	\begin{example}{\bf 3}
		...
		\noindent {\bf ¿Dónde se esconden los choques y las ondas de rarefacción?} ¿Es posible que la solución dependa del método? Recordemos que aunque el dato sea $C^\infty$ pueden aparecer ondas de choque. La respuesta a todas estas preguntas es que estamos utilizando un teorema de existencia y unicidad de \underline{soluciones locales}.
