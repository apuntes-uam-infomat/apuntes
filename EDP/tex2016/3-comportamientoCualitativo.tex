...
%Clase  20-4-2016
	...
	\subsection{Prueba alternativa del resultado de unicidad}
	 ...
	 \subsection{Problema de ``unicidad hacia atrás''}
		...
		\begin{proof}
			...
			Y esto es una contradiccoón con la definición de $t_2$.
	...
	\subsection{Ecuación de difusión en todo el espacio}
		...
		Punto de partida: Solución fundamental (Núcleo de Gauss). Vamos a suponer que la temeperatura inicial es finita. Y la normalizamos con una cantidad de calor = 1. Así buscaremos soluciones que conserven la cantidad total de calor.
