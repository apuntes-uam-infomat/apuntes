	...
	\subsubsection{Propiedad de la media}
		...
		\begin{itemize}
			\item Dirichlet:
				...
				\[ 0 = - \int_{\Omega} w \Delta w dx = - \left\{  \int_{\partial \Omega} \eqreason[w]{= 0} \frac{\delta w}{\delta u} d\sigma = \int_{\omega}|\grad w|^2 dx \right\}  \]
			...
			\item Newman:
				...
				\[ \left. \begin{array}{r}
					-\Delta u = F \text{ en } \Omega \\
					\frac{\delta u}{\delta u}|_{\partial \Omega} = g
					\end{array} \right\} … \left\{ \begin{array}{l}
						- \Delta w = 0 \\
						\frac{\delta w}{\delta u}|_{\partial \Omega} = 0
					\end{array}  \right.  \]
