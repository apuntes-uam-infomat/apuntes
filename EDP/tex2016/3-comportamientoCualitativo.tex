...
\section{Ondas}
	...
	\subsubsection{Propiedad de la media}
		...
		\begin{prop}[Propiedad\IS de la media (bolas en $ℝ^2$)] Sea $\bola_R(\va) ⊆ ℝ^2$ la bola de radio $R$ centrada en $\va ∈ ℝ^2$. Consideramos el problema \[
		\begin{cases}
		...
		\begin{defn}[Desigualdad\IS para funciones sub/superarmónicas]
			...
			\begin{itemize}
				\item $\Delta u \leq 0 \Rightarrow u(0) \leq \frac{1}{|∂ \bola_R|} \int_{∂ \bola_R} u d \sigma_R $
				\item $- \Delta u \geq 0 \Rightarrow u(0) \geq \frac{1}{|∂ \bola_R|} \int_{∂ \bola_R} u d \sigma_R $
			\end{itemize}
