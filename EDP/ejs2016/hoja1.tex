...
\begin{problem}[3] Resolver la ecuación de Burgers $u_t + uu_x = 0$ con dato inicial:
	...
	Como la onda de choque tiene que empezar en $s(1) = 1$, $1 = C·e \to C = \rfrac{1}{e}$ y nuestra ecuación es $s(t) = e^{\sqrt{t}-1}$. El dibujo de características quedaría parecido \footnote{la pendiente de la exponencial se ha acentuado para que se aprecie mejor en el dibujo} en la \fref{fig:Hoja1:E3}.
