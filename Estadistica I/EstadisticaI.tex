...
siendo $R$ la región crítica de cualquier otro test tal que $ \prob[\theta_0]{R} \leq \alpha $. En otras palabras, $ R^\ast $ es el \textbf{test óptimo\index{Test!óptimo} de nivel $\alpha$} para el problema considerado.
...
\[ R=\{(x,q,...,x_n): T_n(x_1,...,x_n) > k_{\alpha}\}\]
...
\[
H_0: \,\theta_i=c_i para i=1,\dotsc, r \leq k y
H_1:\, \theta_1 \neq c_i para algún i=1,\dotsc, r.
\]
...
\[ -2\log \Lambda_n \convdist \chi^2_r \]
\end{theorem}

\subsubsection{Aplicación a tests de bondad de ajuste}\index{Test!de bondad de ajuste}
