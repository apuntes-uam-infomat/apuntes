...
\begin{theorem}[Teorema\IS de la aplicación continua] Sea $\appl{g}{\real}{\real}$ continua en todo punto de un conjunto $C$ tal que $\prob{X\in C} = 1$, entonces
...
\begin{defn}[Estimador\IS de máxima verosimilitud] También llamado EMV o MLE (\textit{maximo likelihood estimator}) es el argumento que maximiza la función de verosimilitud:
