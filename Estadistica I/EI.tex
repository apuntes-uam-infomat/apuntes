...
Uno de los test más usuales es el de igualdad de medias para dos poblaciones \textbf{homocedásticas} \index{Muestras! homocedásticas}, es decir, con $\sigma_1=\sigma_2$.
...
, es decir, cuando cumple la teoría de Neyman-Pearson (\ref{secNeymanPearson}); y además \[ β_n(θ)≥α \;∀θ∈Θ_1 \]
...
\begin{theorem}[Lema\IS de Neyman-Pearson]
