...
\begin{problem}[2]
\solution
\centerline{\includegraphics[page=1,scale=0.8328]{pdf/_T5DatosMercurio.pdf}} % scale obtenido empíricamente para que quepa en la página
\includepdf[pages=2-]{pdf/_T5DatosMercurio.pdf}
\end{problem}
