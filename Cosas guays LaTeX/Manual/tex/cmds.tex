...
\bottomrule \multicolumn{2}{|p{5.5cm}|}{\textbf{InvestigaciÃn operativa:}} \\ \toprule 
...
\verb|\extappl{f}{from}{to}{origen}{destino}| & $\displaystyle\extappl{f}{from}{to}{origen}{destino}$ \\ \midrule 
...
\bottomrule \multicolumn{2}{|p{5.5cm}|}{\textbf{EstadÃ­stica}} \\ \toprule 
...
\verb|\vV| & $\displaystyle\vV$ \\ \midrule 
\bottomrule \multicolumn{2}{|p{5.5cm}|}{\textbf{TopologÃ­a}} \\ \toprule 
...
\bottomrule \multicolumn{2}{|p{5.5cm}|}{\textbf{GeometrÃ­a}} \\ \toprule 
...
\bottomrule \multicolumn{2}{|p{5.5cm}|}{\textbf{Geometría y tpopología}} \\ \toprule 
