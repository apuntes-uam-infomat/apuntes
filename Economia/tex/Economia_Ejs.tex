...
Para ello nos apoyamos en las sensibilidades de la call según la fórmula de Black-Scholes. En concreto la delta $(δ=N(d_+))$ nos da la variación del precio de la call en función del precio del activo correspondiente. Por tanto tenemos
\[C_{BS}(S+ Δt)-C_{BS}(S) = δΔS\]
Por tanto, si compramos acciones $S$ por valor de $δΔS$ estaremos cubiertos ante la posible subida del precio. Puesto que tanto δ como $ΔS$ cambian constantemente, deberemos estar pendientes de la situación y actualizar este dato, es decir, comprar o vender acciones, para mantenernos cubiertos.
\end{problem}
...
\textcolor{red}{Elena: Deben ser iguales?}
