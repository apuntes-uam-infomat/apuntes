...
El coste para la institución financiera será la diferencia entre lo pagado y lo recibido.

\[B_{\text{fix}} = 5\cdot e^{-0.07 \cdot 0.5} + 5 \cdot e^{-0.07} + 5 \cdot e^{-0.07\cdot 1.5} + 5 \cdot e^{-0.07\cdot 2} + 5 \cdot e^{-0.07\cdot 2.5} = 22.53569507\]
\[B_{\text{fl}} = 3.3 \cdot e^{-0.07\cdot 0.5} = 3.186497874\]

Así, para la empresa $A$ el coste ha sido
\[V = B_{\text{fix}} - B_{\text{fl}} = 19349197.2 \text{\texteuro}\]
\end{problem}
