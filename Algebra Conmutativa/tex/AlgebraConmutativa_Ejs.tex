...
Sea \pideal un primo minimal que contiene a $J$. Entonces $\V(\pideal) ⊂ \V(J)$, y además $\V(\pideal)$ ha de ser irreducible por ser primo y por lo tanto radical.

En el otro sentido, si $X_1 \subsetneq X$ es una componente irreducible de $X$, entonces $\I(X_1) ⊃ J$. Luego sigo. Esto no me convence demasiado.
