...
Siguiendo la sugerencia, vemos que $\quot{\K[x_1, \dotsc, x_n]}{\mideal}$ es un cuerpo. Aquí me voy a tirar el triple y decir que entonces tiene que ser igual a $\K$ ya que no podemos hacer que un anillo de polinomios sea un cuerpo así por magia potagia sin volver al anillo original o yendo directamente al cuerpo de fracciones, cosa que no podríamos hacer con un cociente.

En ese caso, tenemos que el punto del medio es igual a $\K$, y entonces seguimos pudiendo poner una extensión algebraica.

\spart

Como ese cociente es un cuerpo, $\pideal$ ha de ser maximal. Y como nos estamos quitando todas las variables, pues tenemos que tener al menos un polinomio por cada variable a quitar, luego $\pideal$ estará generado por $n -1$ elementos efectivamente.

\textit{Triplaco again.}
