...
Si $x ∉ \bigcup X_i$, entonces $∀i = 1, \dotsc, l$, $x ∉ X_i$. Supongamos que todo polinomio $p ∈ J_1 \dotsb J_l$ se anula en $x$. La única posibilidad para que $x ∉ \V(J_1 \dotsb J_l)$ sería que $∀i = 1, \dotsc, l$ exista un subconjunto propio $F_i \subsetneq J_i$ tal que sólo los polinomios de $F_i$ se anulen en $x$, y si $q_i ∉ F_i$ entonces $q_i(x) ≠ 0$. Ahora bien, si tomamos el polinomio $q = q_1 \dotsb q_l$, con $q_i ∉ F_i$, está claro que $q ∈ J_1 \dotsb J_l$ y sin embargo $q(x) ≠ 0$, contradicción porque habíamos dicho que todo polinomio del producto se anulaba en $x$.
