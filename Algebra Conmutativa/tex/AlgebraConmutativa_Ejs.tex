...
\begin{problem}[11] Utiliza el ejercicio anterior para demostrar que dados dos ideales $I,J ⊂ R$ se tiene que $\sqrt{IJ} = \sqrt{I ∩ J} = \sqrt{I} ∩ \sqrt{J}$. \hint{El \fref{ej:Hoja1:5} puede ser útil.}
...
Simplemente viendo la \fref{fig:Hoja7:2} se puede ver que tenemos dos puntos inversos para cada uno de la recta. Que otro saque la ecuación.
