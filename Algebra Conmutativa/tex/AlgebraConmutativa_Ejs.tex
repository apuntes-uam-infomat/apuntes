...
\begin{problem}[6]
	...
	\ppart Todos los pideales primos $\pideal ⊂ B$ tales que $\pideal ∩ A = \gen{x-y}$.
	\ppart Todos los ideales primos $\pideal ⊂ B$ tales que $\pideal ∩ A = \zerogen$.

	\hint{Sea $X = \set{z^3 - xy^2 = 0} ⊂ \afesp[ℂ][3]$, sea $Y = \afesp[ℂ][2]$ y sea $\appl{f}{X}{Y}$ el morfismo inducido por la inclusión $A ⊂ B$. Ahora observa que en el apartado a) se te pide la fibra sobre el punto $(1,2)$, en el b) la bira sobre la recta $x = y$ y en el c) la fibra sobre el plano.}
