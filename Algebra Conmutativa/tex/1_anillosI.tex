...
\begin{defn}[Grupo conmutativo o abeliano]
...
\begin{defn}[Elemento invertible o unidad]
Sea $(R,+,\cdot)$. un anillo, se dice que $a\in R$ es invertible ($a\in \U(R)$) si $\exists b\in R $ \st $a \cdot b = \one$. Es decir, tiene elemento inverso con respecto a la segunda operación $'\cdot'$.
\end{defn}

\begin{defn}[Unidades de R: $\U(R)$]
...
\textbf{Notación:} Sea A un conjunto: $A\setminus \set{0} = A^*$
...
\obs Si $a \in R$ divisor de cero $\implies$ a \underline{\bf NO} es invertible. El recíproco también es cierto. (Las unidades y los divisores de 0 se llevan muy mal)
...
\obs Como $R$ es abeliano con  $'+'$ (recuerden que siempre hablamos de anillos conmutativos con unidad \textcolor{red}{(Solo por ser un anillo ya es (R,+) un grupo conmutativo, no hace falta que sea unitario ni conmutativo el anillo)} entonces si $(I,+)$ es un subgrupo, entonces es un subgrupo normal.  \textcolor{red}{Revisar que esta observación es cierta y quitar este comentario en rojo}
