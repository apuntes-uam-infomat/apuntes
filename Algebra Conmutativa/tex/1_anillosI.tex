...
\begin{prop}
	...
	$$\gen{x_1-a_1,...,x_n-a_n}=\{p(x_1,...,x_n)\in K[x_1,...,x_n]:p(a_1,...,a_n)=0 \}$$
\end{prop}
...
\begin{example}
\begin{itemize}
\item $\ent_9:$ $<\cls{3}>=\{\cls{0},\cls{3},\cls{6} \}$ es el único ideal maximal (por tanto es primo). ($\set{0}$ no es primo)
...
\begin{example}
	\begin{itemize}
		\item En $\ent$: $\set{0} \bigcap_{p\in \ent primo}<p>=\set{0}$
		\item En $\ent_4$: sólo tenemos $<\cls{2}>$
		\item En $\ent_6$: $<\cls{2}>\cap<\cls{3}>=\set{0}$
