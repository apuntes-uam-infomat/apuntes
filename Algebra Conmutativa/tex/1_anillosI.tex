...
\begin{proof}
	...
	Entonces vamos a calcular $\ker(\cls{\pi})$. Que serán los elementos de $I$. Pero como no necesariamente esta $I\subset J$, entonces cogemos los elementos de $I$ qye también pertenecen a $J$. Es decir $\ker(\cls{\pi})=I \cap J$, por tanto:
...
Sea $S \subset R$. Construimos $R×S=\{ (r,s): r \in R, s\in S \}$. Podemos pensar en lugar del par $(r,s)$ en la fracción $\frac{r}{s}=s^{-1}r$, de ahí viene la expresión $S^{-1}R$. Definimos una regla de equivalencia en $R×S$: $(r,s)~(r',s')$ si  $(rs'-r's)=0$.
