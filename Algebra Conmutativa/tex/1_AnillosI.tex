...
\begin{prop}
	Sea $K$ un cuerpo (Esto es cierto también si K es un anillo que no sea cuerpo, confirmado por Ana), y sea el ideal $\gen{x_1-a_1,\dotsc ,x_n-a_n}$ contenido en $K[x_1,\dotsc,x_n]$, entonces:
	$$\gen{x_1-a_1,\dotsc,x_n-a_n}=\set{p(x_1,\dotsc,x_n)\in K[x_1,\dotsc,x_n] \tq p(a_1,\dotsc,a_n)=0 }$$
\end{prop}
...
\begin{prop} \label{prop:NilpotentesInterPrimos}
...
\begin{enumerate}
	...
	\item Esta es la nueva\footnote{La demostración está en el \fref{ej:Hoja2:10}.}:
