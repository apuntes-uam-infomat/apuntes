...
\author{Alberto Parramón \and Guillermo Julián}
\date{15/16 C2}
...
\newcommand{\dk}{\ensuremath{\dim_{\mathrm{Krull}}}\xspace}
...
\newcommand{\mideal}{\ensuremath{\mathfrak{m}}\xspace}
...
\newcommand{\espa}{\ensuremath{\mathbbm{E}}\xspace}
...
\input{tex/2_AnillosII.tex}
\input{tex/3_Variedades.tex}
\input{tex/4_Tma_ceros_Hilbert.tex}
\input{tex/5_Anillos_coordenadas.tex}
\input{tex/6_Dimension_variedades.tex}

%% Apéndices (ejercicios, exámenes)

\appendix

\input{tex/AC_Resumen.tex}
