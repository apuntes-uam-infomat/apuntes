...
Supongamos ahora que se cumple para $n$ y veamos que ocurre para el caso $n+1$:

Queremos probar:
\[z^{n+1}+\frac{1}{z^{n+1}} = P_{n+1}\left(z+\frac{1}{z}\right)\]

Atendiendo nuevamente a la sugerencia del enunciado restamos a ambos lados $\left( z+\frac{1}{z}\right)^{n+1}$ con lo que obtenemos
\[z^{n+1}+\frac{1}{z^{n+1}}-\left( z+\frac{1}{z}\right)^{n+1} = P_{n+1}\left(z+\frac{1}{z}\right) - \left( z+\frac{1}{z}\right)^{n+1} \iff\]

\[\iff \sum_{i=1}^n {n+1 \choose i}z^i\left(\frac{1}{z}\right)^{n-i}= P_{n+1}\left(z+\frac{1}{z}\right) - \left( z+\frac{1}{z}\right)^{n+1}  \iff\]
\[\iff \]
