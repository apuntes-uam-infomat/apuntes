...
\solution
\spart
\[f(z)=f(z^2) \iff \sum_{n=0}^{\infty}z_nz^{2} = \sum_{n=0}^{\infty}a_nz^{2n}\]
...
\begin{problem}[6]
Śea α un número irracional y $q=e^{2πiα}$. Demuéstrese que las únicas soluciones holomorfas de la ecuación funcional $f(z)=f(qz)$ en la coronoa $Ω = \{\frac{1}{2}<|z|<\frac{3}{2}\}$ son las funciones constantes
\solution
\end{problem}
