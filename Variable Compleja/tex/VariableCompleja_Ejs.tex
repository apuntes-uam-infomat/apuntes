...
%
%Por el Teorema de Cauchy, si $f$ es holomorfa en Ω simplemente conexo y α es un camino cerrado en Ω
%
%\[\int_{\text{cuadrado centrado en origen}} (\cos z)^2dz =0\]
%\[\int_{|z|=1} \frac{e^z}{z^2}dz = 2πif'(0)=2πi\]
%
%\end{problem}