...
\spart
%\[\int_{|z-1|=2}\frac{dz}{z^2+3i} = \int_0^{2π}\frac{2\cos(t)+2i\sin(t)}{4\cos^2(t)+1+4\cos(t)-4\sin^2(t)+4\sin(2t)i+2\sin(t)i+3i}dt\]
%\[\int_{|z-1|=2}\frac{dz}{z^2+3i} = \[\int_{|z-1|=2}\frac{dz}{x^2-y^2+i(2xy+3)}\]\]
\end{problem}
...
\[\left| ºf\left( \frac{1}{n}\right) \right|\leq \frac{1}{2^n} \text{ para } n\geq2\]
