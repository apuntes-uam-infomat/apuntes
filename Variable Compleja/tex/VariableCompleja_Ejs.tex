...
donde $α$ es el camino que va de $-3$ a $-1$ a lo largo del eje real, después va de -1 a 1 siguiendo la semicircunferencia superior del disco unidad, luego va del 1 al 3 a lo largo del ejer real y regresa a -3 por la semicirfunferencia superior del círculo $|z|=3$.
