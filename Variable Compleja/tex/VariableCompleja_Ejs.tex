...
\ppart
\[\int_0^{2}\frac{\cos(2t)}{5-4\sin(t)}dt\]
\solution
...
\begin{problem}[14]
Sea Ω un dominio en $\cplex$ y sea $f$ una función holomorfa en Ω tal que para un cierto $M>0$ se tiene que $|f(z)|\geq M$ para todo $z \in Ω$. Pruebe que
...
\begin{problem}[15]
Demuestre que si $f$ es holomorfa en un abierto que contiene al disco unidad cerrado $\bar{\mathbb{D}}$, y si $|f(z)|=0$ cuando $|z|=1$, entonces $f(z)=0$ para todod $z \in \bar{\mathbb{D}}$.
...
\begin{problem}[16]
Sea $f$ una función holomorfa en $\{z \in \cplex \tq |z| < R_0\}$. Demuestre las sigientes fŕomulas
