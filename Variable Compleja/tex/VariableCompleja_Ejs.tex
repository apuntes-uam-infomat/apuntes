...
\end{gather*}
Y la integral queda:
\[\int_{γ_R}\frac{z^2}{(z^2 + 2z + 2)^2}\dif z = 2 \pi i (\frac{1}{2i} \cdot 1 ) = \pi \]

\textcolor{red}{El siguiente resultado contiene un error porque la integral está comprobada con sage.}
