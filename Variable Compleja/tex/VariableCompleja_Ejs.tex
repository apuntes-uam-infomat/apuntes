...
\[\int_α f(z)dz = \int_0^1 i(1+i)dt = i-1 \implies Re\{\int_α f(z) dz\}= -1\]7
...
\solution
\[\left| \int_γ \frac{dz}{z^2+1}\right| \leq \int_γ \left| \frac{dz}{z^2+1}\right| \leq  \int_γ \frac{|dz|}{|z^2+1|} \leq \int_γ \frac{|dz|}{|z^2|-1}\leq\frac{1}{3}\left(π\right)\]
