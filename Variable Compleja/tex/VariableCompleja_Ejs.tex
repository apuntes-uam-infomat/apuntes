...
Para construir esta transformación, debo transformar el borde del disco a la recta real y dejar el interior del disco en el semiplano superior. Para ello, primero construyo $T_1$, que transforma la circunferencia en una recta horizontal de forma que el interior se transforme en la zona superior del plano. Después, la traslado verticalmente con $T_2$ hasta el origen:
\begin{gather*}
[z, -1, -i, 1] = [T_{1}(z), -100i - 1, -100i, \infty] \\
\frac{(z + i)(-2)}{(z-1)(i-1)} = \frac{T_1 + 100i}{-100i -1 + 100i}\\
T_{1} = \frac{2(z+i)}{(z-1)(i-1)} - 100i
\end{gather*}

$T$ es simplemente trasladar $T_1$ verticalmente de forma que el 0 quede en $3+2i$.
\[ T_{2}(z) = T_{1}(z) - T_{1}(0) + 3 + 2i \]

Finalmente, tomamos: $T(z) = T_2(T_1(z))$.

{\color{red} [Jorge]: el problema de hacerlo así, es que al trasladar verticalmente, también mueves hacia arriba la línea horizontal que es imagen de la circunferencia. Y de ese modo la imagen del disco no es $\mathbb{H}$, sino que es $\mathbb{H}+A$. De hecho $T_2(-i) = 4+i$. Pongo lo que se me ha ocurrido a mí:}
...
\[ [z,-1,i,1] = [T(z),a,b,-∞] \]
\[\frac{(z-i)(-1-1)}{(z-1)(-1-i)} = \frac{(T(z) - b)(a + ∞)}{(T(z) + ∞)(a-b)} = \frac{T(z) - b}{a-b}\]
Luego:
