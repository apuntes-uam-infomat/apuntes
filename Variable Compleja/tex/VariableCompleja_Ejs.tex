...
Podemos ver que ambos puntos se encuentran dentro del disco $|z|=t$ siendo $t \geq\left| \frac{1}{2}+i\frac{\sqrt{3}}{2}\right| = 1$. Por tanto vemos que dependiento del valor de $t$ tendremos un resultado para la integral u otro.
