...
\textbf{Ayuda:}  Escriba $f=u+iv$ y use un cálculo director(largo) con la fórmula de Green, o bien aplique un cambio de variables adecuado y relaciones la integral con un área.
\solution
\end{problem}
