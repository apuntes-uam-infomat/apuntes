...
\[\int_{C_R} \frac{e^{iz}}{(z-1)^2+1}\dif z \leq \left|  \int_{C_R}\frac{e^{iz}}{(z-1)^2+1}\dif z\right| \leq \int_{C_R}\left|\frac{e^{iz}}{(z-1)^2+1}\righ||\dif z|\leq\]
...
\[ \int_{-\infty}^{\infty} \frac{e^{iz}}{(z-1)^2+1}\dif z=π\frac{1}{e}\left(\cos(1)+i\sin(1)\]
