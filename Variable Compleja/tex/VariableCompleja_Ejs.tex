...
\spart
Para resolver este apartado basta son sustituir la fórmula que nos dan para la $z$ en la ecuación dado y comprobar que, efectivamente, la ecuación se verifica.
...
\[z=\sqrt[4]{-i}-1\]
%TODO calcular el número. A ella le sale la raiz de -i elevada a un tercio
\spart
Consideranod $z=x+iy$ tenemos que $z^2=x^2-y^2+2xyi$ con lo que llegamos a
\[x^2-y^2 = -5\]
