...
$$\sum_{i=0}^n Ind_\gamma(z_i) =\frac{1}{2\pi i} \int_\gamma \frac{f'(z)}{f(z)}dz$$
...
\begin{itemize}
\item Si $f(z)$ es entera y $|f(z)|<M \implies f$ es constante.
\item Si $f(z)$ es entera y $|f(z)|<a|z|^n \ \forall z > b > 0 \implies f$ es un polinomio de grado menor o igual que $n$.
\end{itemize}
