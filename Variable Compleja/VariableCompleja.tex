...
\[\lim_{h\to 0} \frac{f(z_0+h)-f(z_0)}{h}=\lim_{z\to z_0} \frac{f(z)-f(z_0)}{z-z_0}= f'(z_0)\]
...
La serie $\sum\limits_{n=0}^{\infty}\frac{z^n}{n!}$ tiene radio de convergencia $R=\infty$ pues
\[\lim_{n \to \infty}\left| \frac{a_n}{a_{n+1}}\right| = \lim_{n \to \infty} \frac{(n+1)!}{n!} = \infty\]
Definimos la \textbf{función exponencial} como $e^z=\exp(z)=\sum\limits_{n=0}^{\infty}\frac{z^n}{n!}$.
...
\begin{theorem}[Teorema\IS de Morera]\label{th:Morera}
...
\begin{theorem}[Teorema\IS de la aplicación abierta]\label{th:AplicacionAbierta}
...
es decir, que se trata de una \concept[Singularidad\IS evitable]{singularidad evitable}.
\end{defn}
...
Si $f$ es una función sin singularidades esenciales en Ω y es holomorfa en $Ω \setminus\{\text{polos}\}$, diremos que $f$ es una función \concept[Función\IS meromorfa]{meromorfa}.
...
Resumen relativamente corto de la asignatura, realizado por Guillermo Ruiz Álvarez.
\renewcommand{\theauthor}{Guillermo Ruiz Álvarez}
\renewcommand{\thetitle}{Variable Compleja - Resumen}

\addtocontents{toc}{\protect\setcounter{tocdepth}{1}}
\input{tex/VC_Resumen.tex}
\addtocontents{toc}{\protect\setcounter{tocdepth}{2}}

\renewcommand{\theauthor}{Pedro Valero Mejía}
\renewcommand{\thetitle}{Variable Compleja}
