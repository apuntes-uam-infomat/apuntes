...
Queremos seguir sacando factores de la forma $(z-z_0)$ para llegar al resultado que queremos demostar de modo que repetimos el procedimiento anterior con esta $h_1$.
