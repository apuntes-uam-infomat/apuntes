...
<<<<<<< HEAD
Sea $\appl{f}{\Omega}{\cplex}$ holomorfa en $z_0=x_0+iy_0$ y sean $u(x,y)=Re((f(x+iy)))$, $v(x,y)=Im((f(x+iy)))$, entonces podemos escribir:
\[f(x,y)=u(x,y)+iv(x,y)\]
Básicamente, hemos definido las funciones $u,v$ que nos dan la parte real e imaginaria respectivamente de la función $f$.
=======
%TODO usas z_0 y x_0 indistintamente, y lo ultimo de igualar las cosas no se de donde sale el 1/i y algunas igualdades que haces.
...
>>>>>>> bb6234c148396f70aa19f070e2b7457f8563c44f
