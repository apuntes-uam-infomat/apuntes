...
Diremos que α es \concept{simple}.
...
\begin{theorem}[Teorema de Cauchy-Goursar]
...
\begin{theorem}
Sea Ω un dominio en $\cplex$, R un rectángulo en Ω y $\{z_i\}$ un conjunto finito de puntos en el interior de R se tenemos que:
...
\begin{theorem}[Teorema de Cauchy en el disco]
