...
\subsection{Sigulariedades y polos en términos de la serie de Laurent}
...
Si $f$ es una función sin singularidades esenciales en Ω es decir y es holomorfa en Ω$\setminus\{\text{polos}\}$, diremos que $f$ es una función \concept{meromorfa}
