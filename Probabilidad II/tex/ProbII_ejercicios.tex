...
\begin{expla}
Una función convexa cumple que: $f(tx+(1-t)y) \leq tf(x)+(1-t)f(y)$.
Una función f es cóncava $\Leftrightarrow$ -f es convexa.

Aplicar logaritmo con esta definición y sale ssssseguro
\end{expla}
...
\begin{expla}
No lo he comprobado pero creo que es: $t=\sqrt[p]{w}$ y $u=\sqrt[q]{z}$
\end{expla}
