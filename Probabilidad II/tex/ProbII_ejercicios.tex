...
\newpage
\section{Hoja 7}
\textcolor{red}{A LA ESPERA DE SER CORREGIDA ESTA FATAL}
...
Usando el ejercicio 7 y el hecho de que $Var(X)=1$ \textcolor{red}{Este paso por que?}:
\[
=\mathbb{E}\left(1-\frac{1}{2}\left(\frac{t}{\sqrt{n}}\right)^2+o(\frac{t^2}{n})\right)^n =
\]

Que por el ejercicio 6:
\[
=\left(e^{\frac{-t^2}{2n}}\right)^n=e^{\frac{-t^2}{2}}
\]
