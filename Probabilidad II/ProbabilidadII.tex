...
Además, si $\algb{B}$ esta generada por una partición de $\Omega$, es decir: $\algb{B}=\sigma(\{B_i\}_i\geq 1)$. Entonces podemos definir exactamente esa función y los valores que toma de la siguiente forma:
