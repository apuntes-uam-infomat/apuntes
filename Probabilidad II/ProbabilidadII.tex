...
\obs Como se cumple para $X \in L^1$, también se cumple para $X \in L^p$ , ya que $L^p \subset L^1$. \textcolor{red}{Comprobar que es buena esta observación}
