...
\subsection{Esperanza condicionada como proyección ortogonal en $L^2$}
Recordemos que:
...
\subsection{Esperanza condicionada usando el Teorema de Radon-Nikodyn}
...
\textcolor{red}{QUEDA UNA PROPIEDAD Y PONER ALGUNAS COSILLAS, Y ESTRUCTURAR UN POCO LOS APUNTES, PA ESTE FINDE ESTARÁ HECHO}
\end{enumerate}
