...
Sabemos que $\algb{A}_n$ y $\algb{B}_n$ son $\salgb$s independientes, de modo que si $A \in B_{\infty}=\cap_{n \geq 2} B_n$ entonces $P(A)=0$ ó 1
\begin{proof}
...
Sea $X_{\infty}(w)=\lim_{n \rightarrow \infty} X_n(w)$ (El cual existe c.s. por el teorema de convergencia de las martingalas de Doob para $L^1$).
