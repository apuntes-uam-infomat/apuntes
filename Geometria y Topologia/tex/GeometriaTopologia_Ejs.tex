...
Según la definición de \nlref{def:SumaConexa}, a nivel topológico $M_1^n \hash M_2^n$ es equivalente a la unión de $M_1^n$ y $M_2^n$ quitando un punto a cada una e identificando ciertos puntos. 
Utilizando \fref{prop:CaracteristicaQuitandoPuntos} 
