...
\draw[full directed,thick, blue] (1*\toruscenter,0) circle[radius=\toruswidth];
\end{scope}
...
\foreach \a in {-90,-87,...,90}
{
	...
	\draw[green!\blackpctg!black!\whitepctg!white, dotted] (0,0) circle[radius={\toruscenter+\toruswidth*cos(\a)}];
	\draw[green!\blackpctg!black!\whitepctg!white, dotted] (0,0) circle[radius={\toruscenter-\toruswidth*cos(\a)}];
	\end{scope}
}
