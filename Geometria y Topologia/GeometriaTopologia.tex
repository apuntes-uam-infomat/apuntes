...
Eso. Y alternaciones. Porque las cartas son localmente $ℝ^n$. Y obviamente oinciden para las cartas.
...
Las funciones transición $φ_1$ y $φ_2$ son las funciones transicion tales que $\appl{φ_1}{e^{iθ}}{θ}$ en $(0,2π)$ y  $\appl{φ_2}{e^{iθ}}{θ}$ en $(-π,π)$.
...
\subsubsection{Complejo de De Rham}
