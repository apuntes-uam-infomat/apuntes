...
\dotsb \rar
	& A \rar["f_1"] \dar["\alpha"]
	& B \rar["f_2"] \dar["\beta"]
	& C \rar["f_3"] \dar[red!80!black, "\gamma"]
	& D \rar["f_4"] \dar["\delta"]
	& E \rar \dar["\epsilon"]
	& \dotsb \\
\dotsb \rar
...
\begin{tikzcd}[column sep = 8pt]
  H^p(U) \oplus H^p(V) \rar \dar[green!70!black, leftrightarrow]
& H^p(U ∩ V) \rar \dar[green!70!black, leftrightarrow]
& H^p(M) \rar \dar[red!80!black, leftrightarrow]
& H^{p+1}(U) \oplus H^{p+1}(V) \rar \dar[green!70!black, leftrightarrow]
& H^{p+1}(U ∩ V) \dar[green!70!black, leftrightarrow]
	\\
  H_c^{q}(U) \oplus H_c^{q}(V)
& H_c^{q}(U ∩ V) \lar
& H_c^{q}(M) \lar
& H^{q-1}_c(U) \oplus H^{q-1}_c(V) \lar
& H^{q-1}_c(U ∩ V) \lar
\end{tikzcd}
\tikzexternalenable
\end{center}
...
Suponemos que $H^k(\projcp^{n-1}) =
		\begin{cases}
				1 & k \text{ par}\\
				0 & k \text{ impar}\\
		\end{cases}$ y queremos probarlo para $\projcp^n$
