...
\subsection{Espacio tangente definido por medio de curvas}
...
\subsection{Espacio tangente definido por medio de derivaciones}
...
Un ejemplo es ver que, si tomamos una función $\appl{f}{M}{ℝ}$ y una carta inversa $\inv{φ}(t_1, \dotsc, t_n)$ entonces $\eval[2]{\pd{}{x_i}}_p$ es una derivación que se aplica de la siguiente forma:
