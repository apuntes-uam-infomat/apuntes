...
\caption{Esquema de cómo realizar una suma conexa: se ``quitan'' dos entornos homeomorfos a una bola en ambas variedades y se ``pegan''.}
\label{fig:SumaConexa}
\end{figure}

Las variedades también se pueden construir como suma de otras dos variedades.

\begin{defn}[Suma\IS conexa] Sean $M_1^n, M_2^n$ dos variedades de dimensión $n$. Entonces, para dos cargas $φ_1$, $φ_2$ de $M_1$ y $M_2$ respectivamente lo repetirá otro día.
\end{defn}
