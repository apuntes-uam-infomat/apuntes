...
\begin{theorem}[Teorema\IS de Hopf] Sea $X$ un campo definido en $M$. Entonces el número de ceros ``bien contados''\footnote{No se va a meter en ello pero una parábola con una recta tangente se corta más, se corta más. Si cogemos una recta perpendicular pues se corta en un punto y también en el infinito y etc, etc, etc.} coincide con la \nlref{def:CaracteristicaEuler} de la variedad $M$.
