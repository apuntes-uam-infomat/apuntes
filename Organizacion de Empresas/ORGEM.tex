...
Por ejemplo, \substudy{Apple no patenta} sus productos y se centra en el \textbf{secreto industrial} para proteger sus inventos.
...
%Pedro: TODO que julian haga el dibujito.
%Julian : El dibujito de qué?
%Dejuan : El dibujito de la sección de Organizáción y funciones empresariales.
...
\subsection{Deudas y herencias}

Igual que las deudas se pueden comprar y vender, también pueden heredarse. Sólo se puede evitar o bien rechazando toda la herencia, o bien rechazando las deudas en un juicio (un método que no es infalible). En el caso de que todos los herederos rechacen la herencia, los acreedores cobrarán a beneficio de esa herencia. En cualquiera de los casos, son los acreedores los que han de encontrar a los sucesores, pudiendo solicitar al juzgado la correspondiente identificación.

Además, hay que tener en cuenta que si heredas dinero, esa herencia lleva unos impuestos que tienes que pagar antes de recibir el dinero.

Situación: Tu padre gana la lotería el día antes de su fallecimiento. Gana 500.000 \texteuro en efectivo que vas a heredar tu. La \fref{fig:SimulacionHerencia} simula la deuda que tu contraes antes de oler el dinero (a menos que renuncies a la herencia)

\begin{figure}[hbtp]
\centering
\includegraphics[width=0.7\textwidth]{img/simulacion_sucesiones.png}
\caption{Simulación del impuesto de sucesiones.}
\label{fig:SimulacionHerencia}
\end{figure}
