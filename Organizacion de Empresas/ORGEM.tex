...
\author{Guillermo Julián\\ Pedro Valero \\ Victor De Juan}
\date{15/16 C1}
...
Forma de insolvencia posible (no todas las formas de insolvencia son delitos \textbf{pero las de este tipo si}).
...
Estas diferencias entre la \textbf{contabilidad real} y la \textbf{fiscalmente rentable} se basa, entre otros, en la forma de cobrar y desgrabar el IVA. Ilustremos esto con un ejemplo.
...
No obstante, el Corte Inglés, como tantas otras empresas, tiene la posibilidad de desgrabarse el IVA. Esto es, recuperar del estado una parte (sino el total) del IVA pagado por la compra del producto.

El auténtico ``problema'', más bien complicación en este proceso, es que el Corte Inglés, como cualquier otra empresa, puede desgrabarse el IVA antes de pagar mientras que el vendedor del software (en este caso \textbf{TU}) tiene que pagar el IVA en el momento en que se emite la factura (que no implica que el Corte Inglés te haya pagado).

Es decir, en la vida real, \textbf{TU} le vendes software a una \textbf{Gran Empresa} y no solo tardarás mucho tiempo en cobrar sino que, además, deberás pagar el IVA de un beneficio que aún no has obtenido.
\end{example}

\obs La declaración de la renta se realiza de manea trimestral.
...
Nota: ese título nolo he puesto yo. Pendiente de rellenar porque no sé a qué se refiere.
