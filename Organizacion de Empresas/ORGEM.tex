...
\includepdf[landscape=true, frame=true, noautoscale=true, delta=10 10]{pdf/_Prestamos.pdf}\label{sec:Prestamos}

\includepdf[landscape=true, frame=true, noautoscale=true, delta=10 10]{pdf/_ProyectoInversion.pdf}\label{sec:ProyectoInversion}
