...
\item Sobreestimar el valor que aportas a los usuarios. Pongo un ejemplo: Spotbros es una empresa de mensajería instantánea (competidor de Whatsapp) que se lanzó a bombo y platillo hace unos años con características interesantes. Lp del almacenamiento en la nube o la seguridad extra está muy bien, pero, ¿son relevantes? ¿Va un usuario normal a cambiar de aplicación porque sea ``más segura''? Probablemente no, por muy relevante que nos parezca a nosotros como creadores.
