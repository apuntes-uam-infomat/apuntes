...
La técnica contable lleva la lista de asientos. Un \concept{Asiento} es simplemente el registro de una operación, porque se ve que registro no era una palabra lo suficientemente descriptiva para los economistas y contables. A la izquierda ponemos de dónde sale el dinero (el debe) y a la derecha a dónde va (el haber). Según el PGC\footnote{Plan General de Contabilidad}, hay varias cuentas de donde sale y entra el dinero. La \fref{tab:Asientos} tiene un ejemplo con varias operaciones.
