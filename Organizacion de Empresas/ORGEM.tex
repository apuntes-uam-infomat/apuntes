...
El problema grave es que los impuestos deben pagarse antes de recibir la empresa. Por tanto, atendiendo a una simulación realizada a través de una aplicación online y que recoje la figura \fref{fig:impuestoHerencia}, si nos disponemos a recibir una herencia de 500.000 \texteuro (supongamos que el difunto ganó la lotería poco antes del fallecimiento), el beneficiario de la herencia se ve obligado a pagar más de 100.000 \texteuro antes de poder tener acceso a esa herencia.
