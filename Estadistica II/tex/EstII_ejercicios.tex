...
\[\hat{m}_0 = \hat{β}_0 + \hat{β}_1x_0 = 1.4 + 0.61·7\]
...
\spart
\[E(\tilde{β}_1) = \frac{1}{x_1 - \overline{x}} (E(Y_1) - E(\overline{Y})) = \frac{1}{x_1 - \overline{x}} (β_0+β_1x_1 - E(\overline{Y}))\]

Vamos a ver el valor de $E(\overline{Y})$:
\[E(\overline{Y}) = \frac{1}{n} \sum_{i=0}^n E(Y_i) = \frac{1}{n} \sum_{i=0}^n (β_0 + β_1 x_i) = β_0 + β_1\overline{x}\]

Por tanto al sustituir en la primera ecuación de este apartado obtenemos que $E(\tilde{β}_1)=β_1$, y por tanto el estimador es insesgado.

\spart
\[Var(\tilde{β}_1) = Var\left(\frac{Y_1 - \overline{Y}}{x_1 - \overline{x}}\right) = \frac{1}{(x_1-\overline{x})^2} \left[ Var(Y_1) + Var(\overline{Y}) - 2Cov(Y_1, \overline{Y}) \right]\]
...
\[Var(\overline{Y}) = Var\left( \frac{\sum Y_i}{n} \right) \overbrace{=}^{Y_i \text{ independientes}} \frac{1}{n^2}\sum Var(Y_i) = \frac{σ^2}{n}\]
...
\[Y_i =β_1x_i+ε_i,\ ε_i ≡N(0,σ_2)\text{ independientes},\ i=1,...,n.\]
