...
\spart $X_i \sim N(0,5)$. Además, $cor{X_1,X_2} = 0$.
...
Como $cor{X_1,X_2} = 0$ y ambas variables vienen de un vector normal, concluimos que son independientes.


%Otra manera mucho más corta es utilizar la \fref{prop:tema1_pepino}$. 
...
%\fref{sec:estimadorMaximaVerosimilitud}
...
\[E_i = n·\left( p,p,p,p,p,q,q) = (42.2,...,42.2,58.91,58.91)\right)\]
