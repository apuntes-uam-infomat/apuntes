...
(a) Demuestra que el vector $Y = (Y_1 , Y_2 )$ tiene distribución normal bidimensional y calcula la
distribución del vector $X = (2Y_1 + Y_2 , Y_2 − 2Y_1 )$.
(b) ¿Son las dos distribuciones marginales de X independientes? Determina una matriz B tal que
$X'BX$ tenga distribución $χ^2$ con 2 grados de libertad.
\solution
\doneby{Dejuan}

Este ejercicio es igual que el anterior. Ya lo haré.
...
\begin{problem}[6]
Sea X = (X 1 , X 2 ) un vector aleatorio con distribución normal bidimensional con vector de medias
(1, 1) y matriz de covarianzas
