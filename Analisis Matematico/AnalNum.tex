...
\begin{proof}
 ...
 Sumamos y restamos al numerador $F(a,b+k)$ REVISAR!!
 
 $$\frac{\left|\left(\underbrace{F(\ga+h,b+k) - F(a,b+k)}_{\deriv{F}{x}(a+\tilde{h},b+k) \text{ para algún } 0 \leq\tilde{h}\leq h} -  \deriv{F}{y}(a,b) h\right) + \left(\underbrace{F(\ga,b+k) - F(a,b)}_{\deriv{F}{x}(a+h,b+\tilde{k}) \text{ para algún } 0 \leq\tilde{k}\leq k}- \deriv{F}{y}(a,b) k\right)\right|}{\sqrt{h^2+k^2}}$$
 ...
 \begin{align*}
0 \leq (*) \leq \varepsilon \frac{|h|+|k|}{\sqrt{h^2+k^2}} &\leq C\varepsilon\\
&\uparrow\\
