...
Lemniscata (Rescatar foto)

Cuya parametrización es \[\sigma_5 (x(t),y(t)) = \left(\frac{cos(t)}{sen^2(t)+1},\frac{sen(t)cos(t)}{sen^2(t)+1}\right), t\in \left(\frac{-\pi}{2},\frac{3\pi}{2}\right)\]

A representar en imagen:\\
0 es el extremo derecho de la lemniscata\\
$\frac{-\pi}{2}$ es el origen (de izq arriba a derecha abajo)\\
$\frac{\pi}{2}$ es el origen (de dchaarriba a izq abajo)\\
$\pi$ es el extremo izquierdo.
...
\sigma \text{inyectiva}
\end{array}
\right\}\] NO basta para garantizar que la inversa es continua.
