...
$$\gor{h} \rightarrow 0 \dimplies \gor{\xi} \rightarrow \gor{0}$$
  ...
  \paragraph{Versión copiada en clase:\\}
  Ahora vamos a probar que $A$ está acotado:
  ...
  Aplicamos: $M$ continua, definida en un conjunto compacto $\implies$ $M$ alcanza su máximo y su mínimo(Guille, referencia al teorema¿?). En concreto, si si mínimo es $\delta$ tenemos:
  
  $$ M(v)\geq \delta \implies \frac{1}{A}\leq \frac{1}{\delta} \leq C $$ 
  
  \paragraph{Versión de dejuan:\\}
  Ahora vamos a probar que $A$ está acotado:
  
  $$\frac{1}{A} = \frac{\md{F(x+\xi)-F(x)}}{\md{\xi}} = \frac{\md{F(x+\xi) - F(x) - DF(x)\xi + DF(x)\xi}}{\md{\xi}}$$
  $$\leq \frac{\md{DF(x)\xi}}{\md{\xi}} + \underbrace{\frac{\md{F(x+\xi) - F(x) - DF(x)\xi}}{\md{\xi}}}_{\rightarrow 0}$$
  ...
  Aplicamos: $M$ continua, definida en un conjunto compacto $\implies$ $M$ alcanza su máximo y su mínimo(Guille, referencia al teorema¿?). En concreto, si su máximo es $\Gamma$ tenemos:
  
  $$ M(v)\leq \Gamma \implies \frac{1}{A}\leq \Gamma \leq C $$ 
  
  \paragraph{Fin de conflicto}
