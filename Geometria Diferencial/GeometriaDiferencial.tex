...
Una cosa interesante es que el conjunto de todas las formas multilineales $a$ veces contravariantes y $b$ veces covariantes, que denotaremos por $\topl_b^a(E)$ es un espacio vectorial con las operaciones naturales:
...
\begin{defn}[Producto\IS tensorial] Si tenemos $Φ_1 ∈ \topl_a^b(E), Φ_2 ∈ \topl_c^d(E)$, tenemos que
...
En este caso, tenemos que $Φ_1 \otimes Φ_2 ∈ \topl_{a+c}^{b+d}(E)$.
\end{defn}
