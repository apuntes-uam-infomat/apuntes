...
\begin{abstract}
Apuntes de Geometría Diferencial basados en las clases del profesor Rafael Hernández. Incluye una introducción abstracta --- y algo extensa --- a las formas diferenciales y su definición, definiciones de variedades diferenciales y de los campos y formas sobre ellas, integración sobre variedades y, por último, una introducción a la Geometría Riemanniana (métricas y curvatura) y al teorema de Gauss-Bonnet. Además, el apéndice \ref{sec:Ejercicios} incluye una cantidad importante de ejercicios resueltos sobre los temas correspondientes, aunque, eso sí, no exentos de fallos.
\end{abstract}
