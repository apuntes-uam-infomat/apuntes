...
\begin{defn}[Tensor\IS clásico] Un tensor clásico es una función $\appl{T}{\mathfrak{B}}{\kbb^{n^{a+b}}}$, donde $\mathfrak{B}$ es el conjunto de todas las bases en $E$, de tal forma que \begin{gather*} T(\base) = (T_{j_1,\dotsc, j_b}^{i_1,\dotsc, i^a}) \\ T(\base') = (T_{l_1,\dotsc, l_b}^{k_1,\dotsc, k^a}) \end{gather*}
