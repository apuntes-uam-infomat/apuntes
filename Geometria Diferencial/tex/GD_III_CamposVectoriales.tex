...
\begin{defn}[Corchete\IS de Lie] Dados dos campos $D, D' ∈ \tgsd_x X$, se define el corchete de Lie $[D, D'] ∈ \tgsd_x X$, que nos da otro campo, como \[ [D, D'] ≝ D○D' - D'○D = \sum_j\left(\sum_i a_i \dpa{b_j}{x_i} - b_i \dpa{a_j}{x_i}\right) \dpa{}{x_j}\]
