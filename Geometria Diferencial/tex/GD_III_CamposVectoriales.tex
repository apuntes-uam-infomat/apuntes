...
\begin{enumerate}
\item $[D, D'] = - [D', D]$. Esta se puede ver geométricamente de forma muy sencilla en la \fref{fig:CorcheteLie}: si hacemos el camino al reves, el vector que sale es el inverso.
