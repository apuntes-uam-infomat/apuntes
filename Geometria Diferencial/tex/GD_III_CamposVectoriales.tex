...
\begin{theorem}[Teorema\IS de Frobenius] Sea $Δ$ una distirbución en una variedad $M$ de dimensión $m$. Entonces, Δ es involutiva si y sólo si es completamente integrable.
\end{theorem}
