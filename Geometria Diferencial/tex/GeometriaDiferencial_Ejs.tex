...
Ejercicios correspondientes a \cite[Capítulo 5]{doCarmo94}, teoría en los capítulos \ref{chapGeometriaSuperficies} y \ref{chapGeometriaRiemman}.
...
Ejercicios correspondientes a \cite[Capítulo 6]{doCarmo94}, teoría en los capítulos \ref{chapGeometriaSuperficies}.
...
Esta afirmación es sencilla de comprobar basándonos en el Teorema de Gauss Bonnet, que diec que
...
\begin{itemize}
\item Existe un campo de vectores en $M^2$ que nunca se anula

\item $\chi(M^2)=0$

\item $M^2$ es homeomorfo a un toro.
\end{itemize}
\solution
