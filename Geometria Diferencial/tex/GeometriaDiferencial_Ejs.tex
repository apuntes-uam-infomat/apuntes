...
\spart
\begin{align*}φ\y ψ=xz \dif x \y \dif x \y \dif y + x^2 \dif x \y \dix  y \y \dif z-yz\dif y \y \dif x \y \dif y-yx \dif y \y \dif y \y \dif z = x^2 \dif x \y \dif y \y \dif z\end{align*}
...
Vamos a estudiar el caso $n=2$. Tenemos \[ω=\dif x_1 ∧ \dif x_2 + \dif x_3 ∧ \dif x_4 \]

\[ ω∧ω = \dif x_1 ∧ \dif x_2 ∧ \dif x_3 ∧ \dif x_4\] 

Esto me lleva a pensar que la solución no será 0. La explicación de Pedro está bien, con la salvedad de que el intercambio de 2 diferenciales no cambia de signo ω, ($\dif x ∧ \dif y = - (\dif y ∧ \dif x) = -( -( \dif x ∧ \dif y))$)\footnote{Para convencerse del todo, podemos calcularlo con $n=3$}, es por ello que el resultado final será:
