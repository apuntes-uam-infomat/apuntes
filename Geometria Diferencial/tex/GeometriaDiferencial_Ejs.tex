...
La teoría de este tema se encuentra en el capítulo \ref{chapFormasDiferenciales}.

\subsection{Ejercicios Do Carmo}

Ejercicios recomendados correspondientes a \cite[Capítulo 1]{doCarmo94}.
...
Sugerencia: deriva $g(tx,ty,tz) = t^k g(x,y,z)$ con respecto a $t$ y supón $t = 1$.
...
Sugerencia: $\dif ω = 0$ implica que \[ \dpa{b}{x} = \dpa{a}{y},\quad \dpa{c}{x} = \dpa{a}{z},\quad \dpa{b}{z} = \dpa{c}{y} \] y aplica la relación de Euler del anterior apartado.
