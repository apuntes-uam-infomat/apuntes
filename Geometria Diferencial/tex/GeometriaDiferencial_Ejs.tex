...
\begin{problem}[4] Sea ω una $k$-forma, donde $k$ es impar. Demuestra que $ω \y ω = 0$.
\label{T1_E4}
\solution
...
Para empezar, es posible que estos sumandos sean 0 directamente, cosa que ocurre si estamos en un espacio de dimensión menor que 2k y en este caso no habría nada más que hacer. Esto ocurre si multiplicamos dos 2-formas en $\real^3$\footnote{No se si se representa así. Quiero decir que sólo existen dx, dy y dz} puesto que cada sumando del resultado tendrá un producto de 4 diferenciales escogidos de un conjunto de 3 posibles. Por el principio del palomar es claro que habremos tomado al menos uno repetido, por lo que obtendremos un 0 directamente.
...
\spart
\[φ\y ψ=xz \dif x \y \dif x \y \dif y + x^2 \dif x \y \dix  y \y \dif z-yz\dif y \y \dif x \y \dif y-yx \dif y \y \dif y \y \dif z = x^2 \dif x \y \dif y \y \dif z\]

\spart
\[θ\y φ \y ψ= 0\]

Es fácil de ver apoyándonos en el apartado a) y en la propiedad asociativa del producto exterior.
...
Nos quedarán $n!$ factores, cada uno con una ordenación diferente de los pares $\dif x_i \y \dif x_{i+1}$ de ω. Puesto que estamos recorriendo todas las ordenaciones posibles tendremos que la suma es 0, pues para cada ordenación tendremos también una que sólo implique un intercambio de dos diferenciales y, por tanto, tendrá signo opuesto.

En definitiva, el producto exterior de $n$ copias de ω será 0.
