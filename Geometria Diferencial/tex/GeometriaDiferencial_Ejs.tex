...
\begin{problem}[0] \label{ejEnunciadoRafa} \textit{Enunciado por el profesor en clase.} Consideramos $\bbs^3 ⊂ ℝ^4$, y el toro \[ T_2 = \set{(x,y,z,t) \tq x^2+y^2 = 1,\; z^2 + t^2 = 1}\] que está contenido en $\bbs^3$.
