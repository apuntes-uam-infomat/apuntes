...
Vamos a ver que es una imersión. Para ello, comprobamos que $DF$ es inyectiva. Para ello utilizamos la sugerencia de $F(t) = (cosh(t),senh(t))$ y razonamos: $DF = (senh(t),cosh(t))$ Sean $t_1,t_2∈ℝ$ tales que $F(t_1)=F(t_2)$. Entonces, $cosh(t_1) = cosh(t_2) \implies t_1 = t_2$. CQC.
