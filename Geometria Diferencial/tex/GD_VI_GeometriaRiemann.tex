...
\begin{lemma} $ω_{12} = \gor{ω}_{12} - τ$ donde $τ$ es \[ τ = f ·\dif g - g · \dif f \]
\end{lemma}
...
Sabemos que lo que relaciona una base con la otra es el ángulo $φ_0 = \angle(e_1(p), \gor{e_1}(p))$ cuando $t = t_0$. Lo que querremos ver es que esta relación es siempre la misma, que siempre se mantiene el mismo. ángulo entre ambas bases. Lo que hacemos es definir \[ φ_t ≝ \int_{t_0}^t\left(f \od{g}{t} - g \od{f}{t}\right) \dif t + φ_0 \]
