...
Ahora, con las dos sucesiones que tenemos, $\left\{y_n\right\}_{n=0}^∞, \left\{y(x_n)\right\}_{n=0}^N$, sabiendo que el método es 0-estable, entonces tenemos que $R_n=hδ_n$ y podemos escribir:
...
\begin{example}
	Veamos si el \textbf{método leap-frog es consistente} utilizando \ref{theorem:consist_iif_relaciones}:
	...
	el método cumple con la segunda afirmación del lado derecho del teorema, y podemos afirmar que leap-frog es consistente.
