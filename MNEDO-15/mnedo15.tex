...
En general supondremos que $α_k=1$, eliminando así la arbitrariedad que surge dle hecho de que podemos multiplicar a ambos lados por un mismo número distinto de 0 sin cambiar el método. Además, siempre tendremos que $α_0 \neq 0$ ó $\phi_f$ depende de forma no trivial\footnote{Es decir, aparece $y_n$ como argumento de $f$} de $y_n$.
