...
\[y_n = h^2\sum_{i=1}^{n-1} i = h^2\frac{n(n-1)}{2}=h^2 \cdot\frac{n^2-n}{2} =\frac{x_n^2-hx_n}{2}\footnote{Recordamos que, puesto que el valor inicial era el origen, $x_n=0+nh=nh$}\]
