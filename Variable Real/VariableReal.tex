...
\begin{defn}[Sistema\IS ortogonal completo] Un conjunto $\set{\ve_α}$ es un sistema ortogonal completo de un espacio Hilbert $H$ si y sólo si $\spn \set{\ve_α} \densein H$.
\end{defn}
