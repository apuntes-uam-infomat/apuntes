...
Para verlo bien, podríamos definir una medida \[ μ = \lebg_{ℝ^2} + \lebg_{ℝ} + δ_{0} \], de tal forma que tendríamos que la dimensión del soporte de $\lebg_{ℝ^2}$ es mayor que al de $\lebg{ℝ}$.
