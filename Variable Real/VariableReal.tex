...
El primer ejemplo es el siguiente. Tomaremos $m ∈ \mpos\meds$, y construimos la medida asociada a una función medible $\appl{f}{X}{[0,∞]}$ como $\appl{m_f}{\algb{X}}{[0,+∞)}$ dada por \[ m_f(E) = \int_X \ind_E f \dif m = \int_E f \dif m\]
