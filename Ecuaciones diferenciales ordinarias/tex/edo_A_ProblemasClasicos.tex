...
Esta función toma una función y devuelve un número, por lo que es difícil de manejar. Si definimos
...
Otra forma de resolver el problema de la braquistocrona es aplicando resultados físicos de la óptica.
