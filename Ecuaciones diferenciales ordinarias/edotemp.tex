...
\draw[very thick, red!40!white] (0,0) -- node[midway,sloped] {$>$} (2,4) node[right] {$A=0; B>0$};
\draw[very thick, red!80!black] (0,0) -- node[midway,sloped] {$<$} (-2,-4) node[left] {$A=0; B<0$};

\draw[very thick, orange!40!white] (0,0) -- node[midway,sloped] {$>$} (4,2) node[above] {$A>0; B=0$};
\draw[very thick, orange!80!black] (0,0) -- node[midway,sloped] {$<$} (-4,-2) node[below] {$A<0; B=0$};
