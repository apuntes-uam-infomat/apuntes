...
Ya hemos pasado por un tema de sistemas lineales donde aprendimos a resolver cosas de la forma \[ \begin{cases}x'= a_11x + a_12y \\ y'=a_21x + a_22y \end{cases} \]. 

A partir de aquí teníamos un camino para resolver el problema: coeficientes variables. Otra opción es algo que acaba de explicar y no me he enterado.
