...
\todo{Completar el gráfico de las bandas. La banda es de anchura epsilon, está coloreada.}
...
\draw[very thick,domain=0.8:4.2,smooth,variable=\x,green] plot ({\x}, {0.3*\x + 1 + 0.2*sin(3*\x r)});

\draw[very thick,domain=0.8:4.2,smooth,variable=\x,green!50!white] plot ({\x}, {0.3*\x + 1.5 + 0.2*sin(3*\x r)});

\draw[very thick,domain=0.8:4.2,smooth,variable=\x,green!50!white] plot ({\x}, {0.3*\x + 0.5 + 0.2*sin(3*\x r)});
\end{tikzpicture}
