...
Por comodidad, vamos a girar el plano en que se encuentra la órbita del planeta, $\vr \rightarrow G\vr$, siendo $G$ un giro (matriz ortogonal), para convertirlo en el plano $z=0$.
