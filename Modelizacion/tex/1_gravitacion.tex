...
$$\frac{\dif t}{\dif \theta} = \frac{\dif r \ \dif t}{\dif \theta \ \dif t}= \frac{\dot r}{cte/r^2}\stackrel{=}{\text{despejando en la ecuación anterior}} cte^{-1}r^2\sqrt{\frac{2E}{m}+\frac{cte^2}{r^2}+\frac{2GM}{r}}$$

$$ \frac{\dif r}{r^2\sqrt{...}}=\dif \theta$$

$$\frac{-\dif(\frac{k_1}{r}-k_2)}{}$$
