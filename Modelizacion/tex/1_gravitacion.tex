...
Nos queda que $$\lambda\cos\theta + \mu\sin\theta = \sqrt{\lambda^2 + \mu^2}(\cos\theta_0\cos\theta + \sin\theta_0\sin\theta) \stackrel{A=\sqrt{\lambda^2 + \mu^2}}{\rightarrow} \cos(\theta - \theta_0)A$$\\

Con un giro podemos suponer $\theta_0 = 0$, porque un giro en polares es $\theta \rightarrow \theta + cte$ \\ \\
Teníamos $U = \frac{1}{r} \implies r=\frac{h^2/K}{1 + B\cos\theta}$\\

\textbf{Hecho matemático:} La ecuación general de una cónica en coordenadas polares centradas en u foco y la "orientación habitual" es:\\
...
Tomamos a como el semieje mayor y b como semieje menor de forma que: $$2a = \frac{l}{1+e} + \frac{l}{1-e} \implies a= \frac{l}{1-e^2}$$
$$b = \sqrt{al}$$
Calculamos el área de la elipse utilizando el área de la circunferencia.

Escribimos la circunferencia como $\frac{x^2}{a^2} + \frac{y^2}{a^2} = 1$ , y su área es $\pi a^2$\\
Si hacemos en cambio de $y \rightarrow \frac{a}{b}y$
nos queda $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$ que es la fórmula de la elipse, $\implies$ área $= \pi ab$\\
...
Igualamos el área de la órbita con  el área de la elipse:
...
\begin{enumerate}
\item\textbf{Conservación del momento angular}:\\ $\overrightarrow{L} = \overrightarrow{r} x m \overrightarrow{v}$ ( $\overrightarrow{r} \rightarrow posición ,  \overrightarrow{v} \rightarrow velocidad$).\\$\overrightarrow{L}$ es cte.

\item\textbf{Conservación de la energía}:\\
$\frac{1}{2}m||\overrightarrow{v}||^2 + \frac{GMm}{||\overrightarrow{r}||} \rightarrow$ es cte.
\end{enumerate}
