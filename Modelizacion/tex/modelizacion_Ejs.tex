...
\solution
	...
	$$\overrightarrow x \times \overrightarrow x' = \overrightarrow V_0 que es cte \implies \overrightarrow V_0 \cdot \overrightarrow x = 0 \stackrel{V_0 \neq 0}{\implies} \overrightarrow x \text{está en un plano}$$
...
Como ya tenemos que es regular podemos usar que:
...
$$(\prod) = (x,y,z,t) = (\frac{1}{6}, \frac{5}{18} , \frac{2}{9}, \frac{1}{3})$$
...
Suponemos que variamos el esquema del ejercicio anterior considerando las 4 bolas negras y numeradas. En cada paso elegimos un número al azar y cambiamos de urna la bola correspondiente (sin reemplazarla). Halla la distribución estacionaria.
	...
	\end{cases} \implies \begin{cases}
		a= b \\
		3a/4=3c/4 \implies a=c \\
		c=b/2+d/2\\
		3d/4=3c/4 \implies d=c \\
		e= d \\
		a+b+c+d+e=1
	\end{cases} \implies a=b=c=d=e=1/5\]

	La distribución estacionaría sería:
...
las dos últimas tiradas o el fin del juego. Calcula el número de tiradas esperado del juego.
	...
	\textcolor{blue}{Tengo el mismo problema que en el ejercicio 6. No se como formular lo que viene ahora correctamente.}
