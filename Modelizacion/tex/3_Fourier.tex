	...
	\subsection{Formato JPEG}
		...
		\subsubsection{Cuantificación (cuantización)}
			...
			\begin{framed}
				...
				$$ F \xrightarrow{DCT} \{ a_{nm} \}\limits^{7}_{n,m = 0} \xrightarrow{cuantificación} \left\{ \left[ \frac{a_{nm}}{C_{nm}} + \frac{1}{2} \right] \right\}\limits^{7}_{n,m = 0} $$

				Donde $\left\{ \left[ \frac{a_{nm}}{C_{nm}} + \frac{1}{2} \right] \right\}\limits^{7}_{n,m = 0}$ es el entero más cercano a $\frac{a_{nm}}{C_{nm}}$
			\end{framed}
